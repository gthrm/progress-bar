import { h as histoireConfig, c as customLogos } from './GenericMountStory.vue2-8408zilg.js';
				...
				createElementBlock('div', _hoisted_1$1, [
					...
					createBaseVNode('div', _hoisted_2$1, [
						createBaseVNode(
							'span',
							_hoisted_3$1,
							toDisplayString(unref(animatedCount).toFixed()),
							1
						),
...
const _hoisted_1 = {
	class:
		'histoire-home-view htw-flex md:htw-flex-col htw-gap-12 htw-items-center htw-justify-center htw-h-full'
};
const _hoisted_2 = ['src'];
const _hoisted_3 = {
	class:
		'htw-flex !md:htw-flex-col htw-flex-wrap htw-justify-evenly htw-gap-2 htw-px-4 htw-py-2 htw-bg-gray-100 dark:htw-bg-gray-750 htw-rounded htw-border htw-border-gray-500/30'
};
