import {
	...
	aD as markRaw,
	b3 as shallowRef,
	b4 as getHighlighter,
	T as Transition,
	O as h,
	b5 as onBeforeUnmount
...
async function getSourceCode(story, variant) {
	...
	if (variant.source) {
		...
		const clientPlugin =
			clientSupportPlugins[(_c = story.file) == null ? void 0 : _c.supportPluginId];
		if (clientPlugin) {
...
const _hoisted_4$a = [_hoisted_2$i, _hoisted_3$e];
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		watch(path, () => {
			var _a, _b;
			dasharray.value =
				((_b = (_a = path.value).getTotalLength) == null ? void 0 : _b.call(_a)) ?? 21.21;
		});
		return (_ctx, _cache) => {
			return (
				openBlock(),
				createElementBlock(
					...
					[
						createBaseVNode('div', _hoisted_1$o, [
							...
							(openBlock(),
							createElementBlock('svg', _hoisted_2$g, [
								createBaseVNode(
									'path',
									{
										ref_key: 'path',
		...
		return (_ctx, _cache) => {
			return (
				...
				createElementBlock('div', _hoisted_1$m, [
					!unref(isMobile)
						? (openBlock(),
							createElementBlock('div', _hoisted_2$e, [
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const sizeTooltip = computed(
			() => (responsiveWidth.value ?? 'Auto') + ' × ' + (responsiveHeight.value ?? 'Auto')
		);
		return (_ctx, _cache) => {
			return (
				openBlock(),
												...
												createElementBlock(
													...
													[
														withDirectives(
															...
															[[unref(VTooltip), sizeTooltip.value, void 0, { right: true }]]
														),
														withDirectives(
															(openBlock(),
															createElementBlock(
															...
															[[unref(VTooltip), sizeTooltip.value, void 0, { bottom: true }]]
														),
														withDirectives(
															createBaseVNode(
																'div',
					...
					!unref(isMobile)
						? (openBlock(),
							createElementBlock('div', _hoisted_2$b, [
								...
								!_ctx.variant.responsiveDisabled
						...
						: createCommentVNode('', true),
					((_b = _ctx.story.layout) == null ? void 0 : _b.iframe) === false
						? (openBlock(),
							createBlock(
								_sfc_main$k,
								{
...
const _sfc_main$h = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return hasSingleVariant.value && variant.value
				? (openBlock(),
						...
						popper: withCtx(({ hide }) => [
							createBaseVNode('div', _hoisted_3$6, [
								...
								createElementBlock(
									Fragment,
									null,
									renderList(formattedOptions.value, (label, value) => {
										return (
											openBlock(),
											createElementBlock(
												'div',
				...
				createElementBlock('div', _hoisted_1$c, [
					...
					withDirectives(
						...
						[
							[
								_directive_tooltip,
								savedNotif.value ? 'Saved!' : canEdit.value ? 'Save to preset' : null
							]
						]
					),
					withDirectives(
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return comp.value
				? (openBlock(),
					createBlock(
						resolveDynamicComponent(comp.value),
						{
							key: 0,
			...
			return (
				...
				createElementBlock('div', _hoisted_1$b, [
					...
					createElementBlock(
						Fragment,
						null,
						renderList(_ctx.definition.props, (prop) => {
							return (
								openBlock(),
								createBlock(
									_sfc_main$d,
			...
			return (
				...
				createElementBlock('div', _hoisted_1$a, [
					createBaseVNode('div', _hoisted_2$6, [
						ready.value || !hasCustomControls.value
							? (openBlock(),
								createBlock(
									_sfc_main$e,
									{
...
const _sfc_main$a = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		computed(() => {
			var _a, _b;
			return (
				((_a = story.value.file) == null ? void 0 : _a.docsFilePath) ??
				(props.standalone && ((_b = story.value.file) == null ? void 0 : _b.filePath))
			);
		});
		return (_ctx, _cache) => {
			return (
							...
							createBaseVNode(
								...
								[
									createBaseVNode(
										...
										toDisplayString(_ctx.event.name),
										3
									),
									_ctx.event.argument
										? (openBlock(),
											createElementBlock(
												'span',
												_hoisted_1$8,
												toDisplayString(formattedArgument.value),
												1
											))
										: createCommentVNode('', true)
								],
			...
			return (
				...
				createElementBlock(
					...
					[
						...
						visibleChildrenCount.value < children.value.size
							? (openBlock(),
								createBlock(
									_component_VDropdown,
									{ key: 0 },
									{
										popper: withCtx(() => [
											createBaseVNode('div', _hoisted_2$2, [
												createVNode(
													ChildrenSlice,
													{ start: visibleChildrenCount.value },
													{
							...
							},
							{
								first: withCtx(() => [
									createBaseVNode('div', _hoisted_3, [
										...
										(openBlock(),
										createBlock(
											resolveDynamicComponent(panelContentComponent.value),
											{
												story: unref(storyStore).currentStory,
												variant: unref(storyStore).currentVariant,
