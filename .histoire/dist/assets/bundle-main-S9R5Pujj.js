...
import {
	...
	a as tree,
	b as _sfc_main$c
} from './GenericMountStory.vue2-8408zilg.js';
import {
									...
									!_ctx.story.docsOnly
										? (openBlock(),
											createElementBlock(
												'span',
												_hoisted_3$5,
												toDisplayString(_ctx.story.variants.length),
												1
											))
...
const _hoisted_4$3 = {
	class:
		'htw-flex htw-flex-none htw-items-center htw-opacity-30 [.histoire-story-list-folder-button:hover_&]:htw-opacity-100 htw-ml-4 htw-w-4 htw-h-4 htw-rounded-sm htw-border htw-border-gray-500/40'
};
				...
				createElementBlock('div', _hoisted_1$9, [
					createBaseVNode(
						'div',
						{
							...
							tabindex: '0',
							class:
								'histoire-story-list-folder-button htw-px-0.5 htw-py-2 md:htw-py-1.5 htw-mx-1 htw-rounded-sm hover:htw-bg-primary-100 dark:hover:htw-bg-primary-900 htw-cursor-pointer htw-select-none htw-flex',
							onClick: toggleOpen,
						...
						? (openBlock(),
							createElementBlock('div', _hoisted_6, [
								...
								createElementBlock(
									Fragment,
									null,
									renderList(_ctx.folder.children, (element) => {
										return (
											openBlock(),
											createElementBlock(
												Fragment,
...
const StoryListFolder = /* @__PURE__ */ _export_sfc(_sfc_main$9, [
	['__scopeId', 'data-v-2d2e4786']
]);
const _hoisted_1$8 = {
								...
								[
									...
									createBaseVNode(
										'div',
										{
											...
											tabindex: '0',
											class:
												'htw-px-0.5 htw-py-2 md:htw-py-1.5 htw-mx-1 htw-rounded-sm hover:htw-bg-primary-100 dark:hover:htw-bg-primary-900 htw-cursor-pointer htw-select-none htw-flex htw-items-center htw-gap-2 htw-min-w-0 htw-opacity-50 hover:htw-opacity-100',
											onClick: toggleOpen,
											onKeyup: [withKeys(toggleOpen, ['enter']), withKeys(toggleOpen, ['space'])]
										},
										[
											createVNode(
												unref(Icon),
												{
													...
													class:
														'htw-w-4 htw-h-4 htw-ml-4 htw-rounded-sm htw-border htw-border-gray-500/40'
												},
												null,
												8,
												['icon']
						...
						? (openBlock(),
							createElementBlock('div', _hoisted_5, [
								...
								createElementBlock(
									Fragment,
									null,
									renderList(_ctx.group.children, (element) => {
										return (
											openBlock(),
											createElementBlock(
												Fragment,
...
function genKeyboardShortcutHtml(shortcut) {
	return `<span class="htw-border htw-border-gray-600 htw-px-1 htw-rounded-sm htw-text-gray-400">${shortcut
		.split('+')
		.map((k) => formatKey(k.trim()))
		.join(' ')}</span>`;
}
const _hoisted_1$5 = {
			...
			return (
				...
				createElementBlock('div', _hoisted_1$5, [
					...
					createBaseVNode('div', _hoisted_4$1, [
						...
						!unref(histoireConfig).theme.hideColorSchemeSwitch
							? withDirectives(
									(openBlock(),
									createElementBlock(
										'a',
											...
											createElementBlock(
												...
												[
													...
													createElementBlock(
														Fragment,
														null,
														renderList(folders.value, (file, key) => {
															return (
																openBlock(),
																createElementBlock(
																	Fragment,
													...
													createBaseVNode('span', _hoisted_3$1, [
														...
														createBaseVNode(
															'span',
															_hoisted_4,
															toDisplayString(story.value.variants.length),
															1
														)
													])
												],
...
const _hoisted_1$2 = {
	class:
		'histoire-search-modal htw-fixed htw-inset-0 htw-bg-white/80 dark:htw-bg-gray-900/80 htw-z-20',
	'data-test-id': 'search-modal'
};
const _hoisted_2$1 = {
	class:
		'htw-bg-white dark:htw-bg-gray-900 md:htw-mt-16 md:htw-mx-auto htw-w-screen htw-max-w-[512px] htw-shadow-xl htw-border htw-border-gray-200 dark:htw-border-gray-750 htw-rounded-lg htw-relative htw-divide-y htw-divide-gray-200 dark:htw-divide-gray-850'
};
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		const SearchPane = defineAsyncComponent({
			loader: () =>
				__vitePreload(
					() => import('./SearchPane.vue-05SHYXgw.js'),
...
mountMainApp();
export { onKeyboardShortcut as o, useCommandStore as u };
function __vite__mapDeps(indexes) {
	if (!__vite__mapDeps.viteFileDeps) {
		__vite__mapDeps.viteFileDeps = [
			'assets/SearchPane.vue-05SHYXgw.js',
			'assets/GenericMountStory.vue2-8408zilg.js',
